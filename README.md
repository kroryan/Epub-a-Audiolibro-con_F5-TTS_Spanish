...
Copy and paste this single command line into command prompt to get the app running locally in Docker (Nvidia card accelerated)(11GB)(will download into the folder that you open your command prompt in):
