...
2.  **Download, Load, and Run (Single Command):**
    ...
    * **Command:**
        ```bash
        curl -L "https://huggingface.co/jdana/f5tts_offline_ebook_to_audiobook_Docker_image/resolve/main/f5tts-app-preloaded_2025-03-28.tar" | docker load && docker run --rm -it --gpus all -p 7860:7860 f5tts:latest
        ```
    * **How it works:**
